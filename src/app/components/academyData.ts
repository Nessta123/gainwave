    ...
    lessons: [
      ...
      },
      {
        ...
        content: `
          ...
          <div class="my-6 p-4 bg-black/20 rounded-xl border border-white/10 text-center flex flex-col items-center">
             

[Image of Wyckoff Accumulation schematic]

             <p class="text-[10px] text-zinc-500 uppercase tracking-widest mt-2">Wyckoff Accumulation Model</p>
          </div>
